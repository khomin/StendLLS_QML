...
#pragma pack(0)
    ...
    typedef struct{
        ...
        float cnt_value_min;
        float cnt_value_max;
        float voltage_value_min;
        float voltage_value_max;
        float freq_value_min;
        float freq_value_max;
...
#pragma pack(0)
    ...
    static QString hexToString(char *pdata, uint16_t len);
